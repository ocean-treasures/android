...
import static oceantreasur.es.view.AnimationConstants.DURATION_OF_BIG_FISH_ANIMATION;
import static oceantreasur.es.view.AnimationConstants.FISH_MARGIN_BOTTOM;
import static oceantreasur.es.view.AnimationConstants.FISH_MARGIN_TOP;
import static oceantreasur.es.view.AnimationConstants.MAX_BIG_FISHES;
import static oceantreasur.es.view.AnimationConstants.MAX_DURATION;
import static oceantreasur.es.view.AnimationConstants.MAX_SMALL_FISH;
import static oceantreasur.es.view.AnimationConstants.MAX_SPAWNING_POINT_IN_PERCENTS;
import static oceantreasur.es.view.AnimationConstants.MAX_TIME_OFFSET_BIG_FISH;
import static oceantreasur.es.view.AnimationConstants.MAX_TIME_OFFSET_SMALL_FISH;
import static oceantreasur.es.view.AnimationConstants.MIN_DURATION;
import static oceantreasur.es.view.AnimationConstants.MIN_SPAWNING_POINT_IN_PERCENTS;
import static oceantreasur.es.view.AnimationConstants.MIN_TIME_OFFSET_BIG_FISH;
import static oceantreasur.es.view.AnimationConstants.MIN_TIME_OFFSET_SMALL_FISH;
import static oceantreasur.es.view.AnimationConstants.SPAWNING_POINT_OF_BIG_FISH;
