...
public class CustomButton extends android.support.v7.widget.AppCompatButton {
    ...
    private final CustomTextView.SizeTester mSizeTester = new CustomTextView.SizeTester() {
    ...
    private int efficientTextSizeSearch(int start, int end,
                                        CustomTextView.SizeTester sizeTester, RectF availableSpace) {
        if (!mEnableSizeCache) {
    ...
    private static int binarySearch(int start, int end, CustomTextView.SizeTester sizeTester,
